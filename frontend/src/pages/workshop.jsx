...
import Etabs from '../assets/images/Workshop_Images_2025/Etabs.jpg'
import Drone from '../assets/images/Workshop_Images_2025/Drone.jpg'
import Primavera from '../assets/images/Workshop_Images_2025/Primavera.jpg'

// import SAP2000 from '../assets/images/Workshop_Images_2024/SAP2000.jpeg'
import Comingsoon from '../components/comingsoon';

// const workshop1 = [
//   'Worried about industry skills to add in your resume? MOMENTS’25 Workshops got you covered!!! This is your chance to impress potential employers, boost your project speed, and become an indispensable asset in the field.',
...
const workshop1 = [
  ...
  'Date & Time : 4th Apr 2025',
  'Check out the workshop description for more information.',
];

const workshop2 = [
  'Registration fee: ₹100',
  'Date & Time : 5th Apr 2025',
  'Check out the workshop description for more information.',
];
const workshop3 = [
  'Registration fee: ₹100',
...
{/* <Center as="section" w="100%">
      ...
      <WorkshopCard
          title="ETABS WORKSHOPS BY CSI DELHI"
          description="Learn the fundamentals of structural analysis and design using ETABS at Infrainnovate. Get hands-on experience in modeling. analysis, and real-world applications from industry experts."
          tag= "4th Apr"
          rules={workshop1}
          url={Etabs}
        ...
        <WorkshopCard
          title="DRONES WORKSHOP BY BHUSHAN MADIVAL & KOUSIE"
          description="Discover how drones are transforming land surveying and mapping at Infrainnovate. Learn about aerial data collection, terrain modeling, and real-world applications in civil engineering."
          tag= "5th Apr"
          rules={workshop2}
          url={Drone}
          registerLink="https://unstop.com/o/GvwVZL0?lb=HiMnG0K1"
        />


        <WorkshopCard
          title="PRIMAVERA P6 WORKSHOP BY KARTHIK G & DR.SANTHOSH LOGANATHAN "
